  ...
  return (
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
      ...
      <Tabs defaultValue="whitelabel" className="w-full mt-6">
        <TabsList className="grid w-full grid-cols-3 bg-muted/30 p-1 border rounded-md max-w-md">
          ...
          <TabsTrigger value="ai" className="text-xs font-semibold py-2">AI Settings</TabsTrigger>
        </TabsList>
